    ...
    <header className="fixed top-0 left-0 right-0 z-40 bg-background/80 backdrop-blur-lg border-b border-border/40">
      <div className="container flex h-16 items-center">
        ...
        <nav className="hidden md:flex items-center gap-6 justify-center flex-1">
          ...
          <Link to="/deeds" className="text-foreground/80 hover:text-foreground transition-colors">
            Deeds
          </Link>
          <Link to="/schedule" className="text-foreground/80 hover:text-foreground transition-colors">
            Schedule
          </Link>
          <Link to="/impact" className="text-foreground/80 hover:text-foreground transition-colors">
            Impact
          </Link>
